...
export class IbricksShutterPlatformAccessory extends InternalPlatformAccessory {
  ...
  protected subscribeToCharacteristics(): void {
    this.service.getCharacteristic(this.platform.Characteristic.CurrentPosition)
      .onGet(this._getCurrentPosition.bind(this));

    this.service.getCharacteristic(this.platform.Characteristic.PositionState)
      .onGet(this._getPositionState.bind(this));
    ...
    this.service.getCharacteristic(this.platform.Characteristic.CurrentHorizontalTiltAngle)
      .onGet(this._getCurrentLamella.bind(this));
  }
  ...
  private _setTargetPosition(value: CharacteristicValue): void {
    ...
    this._messageGenerator.setShutter(this._shutter.cello, this._shutter.leftRight,
      this._shutter.convertPositionForCelloValue(this._shutter.targetPosition), -1);
  }
  ...
  private _setTargetLamella(value: CharacteristicValue): void {
    ...
    this._messageGenerator.setShutter(this._shutter.cello, this._shutter.leftRight,
      -1, this._shutter.convertLamellaForCelloValue(this._shutter.targetLamella));
  }
